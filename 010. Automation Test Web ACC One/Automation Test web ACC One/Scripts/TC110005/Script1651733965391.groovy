...
WebUI.verifyElementClickable(findTestObject('TC110005/field - Tipe'))

String text = WebUI.verifyElementNotPresent(findTestObject('TC110004/span_TOYOTA'), 0)

KeywordUtil.markPassed(text)

if (text.contains('ipe')) {
