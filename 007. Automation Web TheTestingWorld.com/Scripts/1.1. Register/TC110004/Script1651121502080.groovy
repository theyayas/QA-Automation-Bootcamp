...
WebUI.setText(findTestObject('Object Repository/1.1. Register/TC110002/input - username'), 'batch288204')

WebUI.setText(findTestObject('Object Repository/1.1. Register/TC110002/input - email'), 'batch288204@xa.com')
...
WebUI.click(findTestObject('Object Repository/1.1. Register/TC110002/input - dob'))

WebUI.click(findTestObject('Object Repository/1.1. Register/TC110002/dob - 1 april 2022'))

WebUI.setText(findTestObject('Object Repository/1.1. Register/TC110002/input - phone'), '085240823989')

WebUI.setText(findTestObject('Object Repository/1.1. Register/TC110002/input - address'), 'Jalan Bangau nomor 12')
