...
WebUI.verifyElementHasAttribute(findTestObject('1.1. Register/TC110002/input - username'), 'required', 0)
...
WebUI.selectOptionByLabel(findTestObject('Object Repository/1.1. Register/TC110002/Gender - Male'), gender, true)
...
if (text.contains('Successfully')) {
    KeywordUtil.markFailedAndStop('ERROR! Berhasil register tanpa email')
}
