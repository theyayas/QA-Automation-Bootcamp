...
WebUI.verifyElementVisible(findTestObject('1.3. Profile/TC130004/label - email'))

WebUI.verifyElementVisible(findTestObject('1.3. Profile/TC130004/icon - email'))

WebUI.setText(findTestObject('1.3. Profile/TC130004/field - email'), '', FailureHandling.OPTIONAL)
