...
WebUI.verifyElementVisible(findTestObject('Object Repository/1.3. Profile/TC130001/Page_My Account  Application Testing Online/a_Welcome Mr. batch288203'))

String text = WebUI.getText(findTestObject('Object Repository/1.3. Profile/TC130001/Page_My Account  Application Testing Online/a_Welcome Mr. batch288203'))

if (text.contains("batch288203")) {
	KeywordUtil.markPassed("Berhasil log in")
}
else {
	KeywordUtil.markError("Log in tidak sesuai")
}
