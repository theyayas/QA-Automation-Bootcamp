...
WebUI.verifyElementVisible(findTestObject('1.3. Profile/TC130005/label - Password'))

WebUI.verifyElementVisible(findTestObject('1.3. Profile/TC130005/icon - Password'))

WebUI.verifyElementVisible(findTestObject('1.3. Profile/TC130005/field - Password'))

String values = WebUI.getAttribute(findTestObject('1.3. Profile/TC130005/field - Password'), 'value')

if (values.contains('123456789')) {
    KeywordUtil.markPassed('Sesuai')
}

WebUI.setText(findTestObject('1.3. Profile/TC130005/field - Password'), ' ')
