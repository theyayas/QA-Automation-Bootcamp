...
WebUI.verifyElementVisible(findTestObject('1.3. Profile/TC130003/label - User Name'))

WebUI.verifyElementVisible(findTestObject('1.3. Profile/TC130003/Icon - User Name'))

WebUI.setText(findTestObject('1.3. Profile/TC130003/Field - User Name'), ' ', FailureHandling.OPTIONAL)
