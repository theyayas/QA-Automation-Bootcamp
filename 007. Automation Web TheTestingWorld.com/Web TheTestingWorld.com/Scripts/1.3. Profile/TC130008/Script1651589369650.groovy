...
WebUI.verifyElementVisible(findTestObject('1.3. Profile/TC130008/label - Gender'))

WebUI.verifyElementVisible(findTestObject('1.3. Profile/TC130008/option box - Gender'))

WebUI.verifyOptionsPresent(findTestObject('1.3. Profile/TC130008/option box - Gender'), ['Choose Gender', 'Male', 'Female'])

WebUI.selectOptionByLabel(findTestObject('1.3. Profile/TC130008/option box - Gender'), 'Female', true)
